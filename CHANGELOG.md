...
- `Badge` atom (small, style-driven status label for displaying status, count, or tag information) with `BadgeStyle` and presets (`.default`, `.neutral`, `.accent`, `.success`, `.warning`, `.error`, `.outlined(_:)`).
